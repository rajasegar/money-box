...
export default function Emergency() {
  return (
    <div className={styles.container}>
	  ...
	  <ul>
	  <li>At times, 3 year FD <a target="_blank" href="https://www.bankbazaar.com/fixed-deposit-rate.html">gives</a> more than 5 year FD</li>
	  <li>Cost of about 0.5 % of interest for an <a href="https://www.paisabazaar.com/fixed-deposit/premature-withdrawal-of-fixed-deposit/" target="_blank">early exit</a> from FD</li>
	  ...
	  <h2>Mutual Funds</h2>
	  <ul>
	  <li>Choose a fund that is <a href="https://www.etmoney.com/mutual-funds/hybrid/conservative-hybrid/71" target="_blank">conservative</a> and not aggressive.</li>
